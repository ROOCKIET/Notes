...
d.dddE+n指的是将小数点右移n位，而-n指的是将小数点左移n位

float最少32位

double最少48位，一般64位

long double》=double ，一般80/96/128

在cfloat/float.h中找到限制

cout所属的ostream类有一个类成员函数，可以控制输出的格式，字段宽度，小数位数，采用小数格式还是e格式等
...
/ 除法取整.整数之间运算取整，有浮点数参与则保留小数点//运算符重载实现
